...
## Приложение для построения табличных функций котировок акций с использованием методов интерполяции: полином Ньютона или методом кубических сплайнок и с использованием методоа аппроксимации методом наименьших квадратов с полиномом выбранной степени.
